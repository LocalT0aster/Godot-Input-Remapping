...
func _refresh_copy_and_delete_examples() -> void:
	...
	if MaaacksInputRemappingPlugin.instance.get_copy_path() != examples_path:
...
func _on_set_main_scene_button_pressed():
	tree_exited.connect(func(): MaaacksInputRemappingPlugin.instance.open_main_scene_confirmation_dialog(MaaacksInputRemappingPlugin.instance.get_copy_path()))
	queue_free()

func _on_set_default_theme_button_pressed():
	tree_exited.connect(func(): MaaacksInputRemappingPlugin.instance.open_theme_selection_dialog(MaaacksInputRemappingPlugin.instance.get_copy_path()))
	queue_free()
